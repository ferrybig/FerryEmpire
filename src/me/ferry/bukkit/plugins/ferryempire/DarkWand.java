 ...
 * @author Fernando
 */
public class DarkWand extends RodBase implements ConfigurationSerializable {
	...
	public DarkWand(Map<String, Object> map) {
	...
	private static ItemStack buildItemStack(Material mat, Skill firstSpell, DarkWand main) {
